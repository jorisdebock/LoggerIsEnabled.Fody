...
public static class Decompiler
{
    ...
    static Decompiler()
    {
        ...
        _exePath = Directory.EnumerateFiles(windowsSdk, "ildasm.exe", SearchOption.AllDirectories)
            .OrderByDescending(x =>
            {
    ...
    public static string Decompile(string assemblyPath, string identifier = "")
    {
        ...
        using (var process = Process.Start(new ProcessStartInfo(_exePath, $"\"{assemblyPath}\" /text /linenum {identifier}")
        {
